...
let defaultHand = {cards: [new Card(0, 0, 'V'), new Card(1, 0, 'R'), new Card(2, 0, 'R'), new Card(3, 0, 'I'), new Card(4, 0, 'H'), new Card(1, 0, 'VIRUS'), new Card(3, 0, 'POWEROUTAGE'), new Card(4, 0, 'G')]}
