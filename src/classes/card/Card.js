 ...
 * This class is not intended to used directly. Each card type should be a
 * subclass that, at minimum, implements the 'play' method as necessary
...
class Card {
   ...
   * @param {Deck} value - The deck the card comes from
