...
const CARD_ORDER = {
  ...
  standard: [
    ...
    "OVERCLOCK", "STACKOVERFLOW", "SQLINJECTION", "RANSOM", "TROJAN", "VIRUS"
  ],
  aggressive: [
    "STACKOVERFLOW", "SQLINJECTION", "VIRUS", "RANSOM", "TROJAN", "VARIABLE", "REPEAT", "INSTRUCTION", "METHOD",
    "FIREWALL", "ANTIVIRUS", "OVERCLOCK"
  ],
  defensive: [
    "FIREWALL", "ANTIVIRUS", "OVERCLOCK", "METHOD", "VARIABLE", "REPEAT",
    "INSTRUCTION", "TROJAN", "STACKOVERFLOW", "SQLINJECTION", "VIRUS", "RANSOM"
  ]
}
