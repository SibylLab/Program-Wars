<template>
  <div id="card" :class="cardCss" class="panel panel-default" @click="cardClicked ($event)" @click.stop draggable="true" @dragstart="cardDragged">
    <img src="../../../static/cardImg/backOfCard.png" alt="back of Card" width ="90" height="134" v-if="false">
...
export default {
  ...
  methods: {
    ...
    cardDragged(e) {
      ...
      showCard(){
        return (this.isAi && this.cardData.type !== 'GENERATOR' && this.cardData.type !== 'FIREWALL' && this.cardData.type !== 'ANTIVIRUS'
            && this.cardData.type !=='VIRUS' && this.cardData.type !=='H' && this.cardData.type !=='POWEROUTAGE');
}
  }
}
</script>
